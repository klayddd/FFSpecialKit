...
//        NSDictionary *author = [reformer reformData:data[kAuthorReformer]];
        ...
        UIImage *placeholderHeader = load_bundle ? [UIImage ff_imagePathWithName:@"pc_default_avatar" bundle:@"FFSpecialKit" targetClass:[self class]] : [UIImage imageNamed:@"placehodler"];
...
- (UILabel *)categoryLabel{
    if (_categoryLabel == nil) {
        ...
        NSString *fontName = load_bundle ? (NSString *)[NSObject ff_customFontPathWithName:FONT_FAMILY_CODE_LIGHT bundle:@"FFSpecialKit.bundle" targetClass:[self class]] : FONT_FAMILY_CODE_LIGHT;
